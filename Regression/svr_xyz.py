...
# User settings
DATA_DIR = r"./slow walking/data1/syn"
...
VI_T_COL = 0
VI_VEL_COLS = [5, 6, 7]       # vx vy vz

# Feature construction
N_LAGS = 20                   # number of IMU samples in the past to stack
...
def build_xy_for_sequence(imu_df: pd.DataFrame, vi_df: pd.DataFrame,
    ...
    #For each VI timestamp, find the latest IMU sample at/before that time,then stack the previous n_lags IMU rows as features. 
